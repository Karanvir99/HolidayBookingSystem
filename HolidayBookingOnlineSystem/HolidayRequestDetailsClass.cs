...
{
    public class HolidayRequestPageClass
    {
        readonly DataClasses1DataContext db;
        readonly ValidationClass v;

        public HolidayRequestPageClass()
        {
        ...
        public void LoadHolidayRequests(GridView grid)
        {
            ...
            var HolidayRequests = (from h in db.cpHolidayRequests
                                   ...
                                   select new { h.HolidayRequestID, h.UserID, h.startDate, h.endDate, h.status });
